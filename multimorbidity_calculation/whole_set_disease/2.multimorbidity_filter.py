...
if __name__ == '__main__':
    ...
    df = pd.read_csv('../phenotype/multimorbidity_alldisease.csv')
    list1 = df.values.tolist()
    ...
    print(df2.shape[0])
    df2.to_csv('../phenotype/multimorbidity_filter_alldisease.csv', index=False)
    ...
    print(' ------- common disease multimorbidity by whole set of diseases ------- ')
    ...
    df4 = pd.read_csv('../phenotype/multimorbidity_filter.csv')
    ...
    print('------- common disease multimorbidity intersaction between using whole set of diseases and subset of diseases -------')
    print(len(set1))
    print(len(set2))
    print(len(set1 & set2))