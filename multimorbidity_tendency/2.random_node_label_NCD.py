...
print('total icd9 codes mapped in multimorbid diseses: ' + str(i))
...
list1 = multimor_df.values.tolist()
set1 = set()
for each in list1:
    code1 = each[0]
    code2 = each[1]
...
df.to_csv('../network_random/multimorbid_tendency_NCD.csv', index=False)