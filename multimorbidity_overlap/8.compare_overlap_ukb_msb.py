...
if __name__ == '__main__':
    ...
    with open('../overlap/multimorbidity_snp.txt', 'r') as infile:
        for i, line in enumerate(infile):
            ...
            str2 = str1.split('\t')
            code1, code2 = str2[:2]
            ukb_multimorbidity_snp.add((code1, code2))
        infile.close()

    ukb_multimorbidity_gene = set()
    with open('../overlap/multimorbidity_gene.txt', 'r') as infile:
        for i, line in enumerate(infile):
            ...
            str2 = str1.split('\t')
            code1, code2 = str2[:2]
            ukb_multimorbidity_gene.add((code1, code2))
        infile.close()

    ukb_multimorbidity_ppi = set()
    with open('../overlap/multimorbidity_ppi.txt', 'r') as infile:
        for i, line in enumerate(infile):
            ...
            str2 = str1.split('\t')
            code1, code2 = str2[:2]
            ukb_multimorbidity_ppi.add((code1, code2))
        infile.close()

    ukb_multimorbidity_pathway = set()
    with open('../overlap/multimorbidity_pathway.txt', 'r') as infile:
        for i, line in enumerate(infile):
            ...
            str2 = str1.split('\t')
            code1, code2 = str2[:2]
            ukb_multimorbidity_pathway.add((code1, code2))
        infile.close()

    ukb_multimorbidity_rg = set()
    with open('../overlap/multimorbidity_rg.txt', 'r') as infile:
        for i, line in enumerate(infile):
            ...
            str2 = str1.split('\t')
            code1, code2 = str2[:2]
            ukb_multimorbidity_rg.add((code1, code2))
        infile.close()
    ...
    set1 = genetic_multimorbidity & msb_diseasePair
    print(len(set1))


    a = len(msb_diseasePair & (ukb_multimorbidity_snp | ukb_multimorbidity_gene | ukb_multimorbidity_ppi | ukb_multimorbidity_pathway | ukb_multimorbidity_rg))
    b = len(msb_diseasePair & genetic_multimorbidity) - a
    c = len((ukb_multimorbidity_snp | ukb_multimorbidity_gene | ukb_multimorbidity_ppi | ukb_multimorbidity_pathway | ukb_multimorbidity_rg)) - a
    d = 8212 - a - b - c
