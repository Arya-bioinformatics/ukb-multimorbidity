...
with open('../overlap/multimorbidity_snp.txt', 'r') as infile:
    for i, line in enumerate(infile):
        ...
        str1 = line.strip('\r\n')
        str2 = str1.split('\t')
        multimorbidity_snp[(str2[0], str2[1])] = set(str2[4].split(';'))
    infile.close()
...
with open('../overlap/multimorbidity_gene.txt', 'r') as infile:
    for i, line in enumerate(infile):
        ...
        str1 = line.strip('\r\n')
        str2 = str1.split('\t')
        multimorbidity_gene[(str2[0], str2[1])] = set(str2[4].split(';'))
    infile.close()
...
with open('../overlap/multimorbidity_ppi.txt', 'r') as infile:
    for i, line in enumerate(infile):
        ...
        str1 = line.strip('\r\n')
        str2 = str1.split('\t')
        multimorbidity_ppi[(str2[0], str2[1])] = set(str2[4].split(';'))
    infile.close()
...
with open('../overlap/multimorbidity_pathway.txt', 'r') as infile:
    for i, line in enumerate(infile):
        ...
        str1 = line.strip('\r\n')
        str2 = str1.split('\t')
        multimorbidity_pathway[(str2[0], str2[1])] = set(str2[4].split(';'))
    infile.close()

list1 = list()
for each in multimorbidity_snp:
    code1, code2 = each
    a = len(multimorbidity_snp[each])
...
for each in multimorbidity_gene:
    code1, code2 = each
    a = len(multimorbidity_gene[each])
...
while i < 10000:
    ...
    for each in multimorbidity_pathway:
        a = len(multimorbidity_pathway[each])
        code1, code2 = each
        set1 = set()
...
all_interpreted_multimorbidity = set()
for each in multimorbidity_snp:
    all_interpreted_multimorbidity.add((each[0], each[1]))
for each in multimorbidity_gene:
    all_interpreted_multimorbidity.add((each[0], each[1]))
for each in multimorbidity_ppi:
    all_interpreted_multimorbidity.add((each[0], each[1]))
...
list1 = list()
for each in all_interpreted_multimorbidity:
