...
for each in list1:
    ...
    if (code1 in genetic_disease) & (code2 in genetic_disease):
        ...
        genetic_multimorbidity.append([code1, code2, c1, c2])

genetic_df = pd.DataFrame(genetic_multimorbidity, columns=['code1', 'code2', 'category1', 'category2'])
