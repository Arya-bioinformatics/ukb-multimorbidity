...
snp_overlap = list()
c = file('../overlap/multimorbidity_snp.txt',"r")
...
gene_overlap = list()
c = file('../overlap/multimorbidity_gene.txt',"r")
line=readLines(c,n=1)
line=readLines(c,n=1)
while( length(line) != 0 ) {
  x = strsplit(line, '\t')
...
ppi_overlap = list()
c = file('../overlap/multimorbidity_ppi.txt',"r")
line=readLines(c,n=1)
line=readLines(c,n=1)
while( length(line) != 0 ) {
  x = strsplit(line, '\t')
...
c = file('../overlap/multimorbidity_pathway.txt',"r")
line=readLines(c,n=1)
line=readLines(c,n=1)
while( length(line) != 0 ) {
  x = strsplit(line, '\t')
...
rg_overlap = list()
c = file('../overlap/multimorbidity_rg.txt',"r")
line=readLines(c,n=1)
line=readLines(c,n=1)
while( length(line) != 0 ) {
  x = strsplit(line, '\t')
